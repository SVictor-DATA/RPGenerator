...
def generate_story(model, start_seq, char_to_int, int_to_char, seq_length, min_length=100, max_length=300, temperature=0.5):
    story = start_seq
    sentence_end = False
...
def generate_another_story(model, start_seq, char_to_int, int_to_char, seq_length=5, min_length=50, max_length=200, temperature=0.5):
    while True:
        # Gera a história
...
if os.path.exists(model_filename):
    ...
    model.fit(X, y, epochs=1000, batch_size=64, callbacks=[checkpoint])
