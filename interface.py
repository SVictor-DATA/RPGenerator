...
profile_image = load_and_resize_image("guerr.png", 200, 200)  # Tamanho do campo de perfil
...
# Função para exibir o personagem nos campos de texto
...
def criar_personagem():
    # Exemplo fictício, substitua pelos valores gerados dinamicamente
...
# Botão Refazer Classes e Atributos (placeholder para funcionalidade futura)
botao_refazer_classes = Button(
    window,
    text="Refazer Classes e Atributos",
...
# Botão Criar nova História (placeholder para funcionalidade futura)
...
# Botão Criar Nova História IA (Beta) (placeholder para funcionalidade futura)
